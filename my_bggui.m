function h = my_bggui(bho)
%BGGUI class constructor.


% Copyright 2003-2014 The MathWorks, Inc.

%h = my_bggui; % constructor
h = [];
...
% Set 'PickableParts'
% pickablePVPairsNone = {'PickableParts','none'};
...
% if ~isequal(class(bh),'biograph.biograph') || ~(ishghandle(bh.hgAxes)&&strcmp(get(bh.hgAxes,'Type'),'axes'))
%     return
% end
% 
